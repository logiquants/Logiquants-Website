...
<span style="color:black"><span style="font-family:Arial; font-size:1.2em;">**‣** There's a minimum amount of $1000 required to open an account</span></span>  
...
<span style="color:black"><span style="font-family:Arial; font-size:1.2em;">     1. Open an account using promo code 5FREETRADES, and fund it with $1000+ by Dec.      &nbsp;&nbsp;&nbsp;&nbsp;31, 2022 to receive 5 free trades ($24.75-$49.75 in value). Additional &nbsp;&nbsp;&nbsp;&nbsp;conditions apply (full details of the promotion can be found here).</span></span>  
